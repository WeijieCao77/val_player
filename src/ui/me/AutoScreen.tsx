...
import { AUTO_RESERVE } from '../../engine/me/auto'

const DIALS: { key: 'buy' | 'biz' | 'daily' | 'career'; name: string; what: string; rules: string[] }[] = [
  { key: 'buy', name: '采购', what: '外设、课程、理疗', rules: [`先留 ${money(AUTO_RESERVE)} 的安全余额`, '疲劳 ≥70 先买理疗', '外设换到职业级为止，旗舰不碰', '心态低于 50 报运动心理课；人在国外报语言课'] },
  { key: 'biz', name: '商务', what: '直播独家、杯赛报名', rules: ['粉丝离天花板还远（<60%）不签独家，签了也只签俱乐部的合作平台，永远不签来抢人的那家', '杯赛：钱够、够资格就报，路人队友随机；签了约以后不替你报，去不去你自己定', '杯赛的比赛日和联赛比赛一样停下来等你打；快进到赛段末、赛季末时按推荐替你打，伤得重就弃权'] },
