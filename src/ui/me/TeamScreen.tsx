        ...
        <Panel title="首发之争">
          <p className="small" style={{ margin: '0 0 6px' }}>
            {team.starters.includes(me.id)
              ? (me.trial ? `试用期，还剩 ${me.trial.left} 场。赢球或打出队内前二就算过。` : me.proven ? '你是教练认定的首发。连着三场全队最差会被换下。' : '本周你在名单里——是因为数值压过了别人，教练还没把你当自己人。')
              : `资本 ${me.edge.toFixed(1)}/${EDGE_NEED}。对位挑战赢一次 +1（三局全胜 +1.5），输一次 −0.5，攒够了教练给试用期。`}
          </p>
          <p className="tiny faint" style={{ margin: 0 }}>
            教练每周重排名单：看综合、看这周的状态和疲劳、看他对你的信任；新人的数据要打折，直到他亲眼看过足够多的回合。
          </p>
        </Panel>
      </div>
    </div>
