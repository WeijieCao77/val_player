/**
 * The career's building blocks: money, rating badges, role tags, bars, crests,
 * agent icons, panels, modals, dates and the two radars.
 *
 * Copied from the manager game's ui/common.tsx when the career became a game
 * of its own (作者 2026-09-11) — only what the career draws, and none of the
 ...
 *
 * The filename strips everything non-alphabetic (KAY/O → KAYO.png). The title
 * carries the Chinese name and the job, so hovering answers what the icon
 * alone cannot.
 */
...
/** Condition read-out used in roster lists: the bar's colour, the figure on hover when `hideNumber`. */
 ...
 * would sit one day behind the one in the header (which counts from the save's
 * own year). Pass the save's year.
 */
