...
/**
 * A knockout drawn as a bracket rather than listed as placings. The career's
 * own copy of the manager game's bracket.
 *
 ...
 * one. A Masters opens with its Swiss round: the table of records, then the
 * rounds. Champions opens with its four groups. A Challengers bracket is still
 * one lane.
 */
...
function Tie({ f }: { f: Fixture }) {
  ...
  return (
    ...
    >
      ...
      {/* a tie still to be played says when */}
      {!r && (
