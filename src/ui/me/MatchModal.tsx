...
/**
 * A played match's sheet: the maps, why each went the way it did, the rounds,
 * the performance radar and the scoreboard. The career's own copy of the
 * manager game's match modal, without the manager's reading notes.
 */
