...
const buildSections = (drawn: boolean): Section[] => [
  ...
  },
  {
    ...
    up: [
      ...
      { t: '每周自然回暖', d: '朝 +10 回归，速度 =（10 − 现值）×（1.2% +（教练激励 − 55）÷ 100 × 3%）× 你的带队技能。'
        + '恨意会淡，但比结下来慢得多——输一场比赛能扣掉十几点，回暖一周只有零点几。' },
      { t: '双人训练', d: '唯一能直接、定向修一对关系的手段。' },
      { t: '团建（俱乐部活动）', d: '集训营让在场的每一对 +5~9，粉丝开放日和观赛派对 +1~3，拍摄 0——只有集训营是真的在建队。' },
    ],
    down: [
      { t: '输了比赛，而且一个人扛了另一个没跟上', d: '扣的是「评分差 × 20~34 × (1.35 − 扛的人的耐心) × 记仇系数」。'
        + '耐心 =（团队配合 + (100 − 野心)）÷ 200，所以脾气好、不争强的人扛完不记恨。'
        + '记仇系数 = 1 + 已有恶感 ÷ 55——同样一件事，本来就不对付的两个人扣得狠得多。' },
      { t: '输了比赛，但两个人都打得差', d: '只扣 0.3~2。都没打好就没什么可怪对方的。' },
  ...
  },
  {
    key: 'chem',
    title: '全队默契',
    lede: '不是单独的一个属性，就是队内所有两两关系的平均数。队内关系面板顶上那个数。',
    use: [
  ...
  },
  {
    key: 'style',
    title: '阵容风格与滑杆',
    lede: '一套五个特工有它的形状：<b>双决斗</b>（两个决斗者）、<b>双哨卫</b>、<b>双控场</b>，'
  ...
  },
  {
    key: 'fam',
    title: '阵容熟练度',
    lede: '地图熟练度说的是队伍多熟这张图；阵容熟练度说的是多熟<b>这张图上这五个特工</b>。每张图一个数，'
  ...
  },
  {
    key: 'trust',
    title: '对你的信任',
    lede: '选手对经理本人的长期评价，从 62 起步。和士气分开：士气是这周的情绪，'
    ...
    up: [
      ...
      { t: '带队技能', d: '正向的部分乘以它，负向的部分除以它——会带人的经理攒得快、掉得慢。' },
    ],
    down: [
  ...
  },
  {
    ...
    use: [
      ...
      + '<b>「对这支战队没有太深的归属感」这句话，说的就是这一条。</b>',
      '你去问价别队选手时，他的态度里还要再扣一次 (忠诚 − 50) × 0.5——这里比合同分量更重。'
  ...
  },
  {
    ...
    up: [
      { t: '承诺了核心/首发却不上', d: '每周 +7（首发承诺 +4.5），带队技能能减缓。' },
    ...
    use: [
      ...
      + '比盯着他们的合同年限有用。',
      '反过来，你问价别队选手时，他自己的态度里也算这个：不满 >35、士气 <45 或者合同只剩一年，'
      + '接受度 +25。',
  ...
  },
  {
    ...
    use: [
      ...
      '挖人：(你的声望 − 对方俱乐部声望) × 0.55 直接加到选手的接受分。',
