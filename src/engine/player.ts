 ...
 * A player there keeps no progress: the bank of three points' worth that landed when the ceiling opened
 * (「存点数」) is gone since 2026-09-14 — his hours there count toward breaking it (me/bottleneck.ts).
 */
