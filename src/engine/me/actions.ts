...
export const ACTIONS: ActionDef[] = [
  { key: 'aim', label: '枪法训练', cost: 2, desc: 'Aim Lab 与 DM，练枪法与反应', attrs: ['aim', 'reaction'], fatigue: 8, group: 'train' },
  ...
  { key: 'content', label: '做内容', cost: 2, desc: '剪辑、vlog、采访；涨热度，粉丝多了也有点钱', fatigue: 4, group: 'life' },
