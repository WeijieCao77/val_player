...
export const KEY_HL: Record<string, HlOpt[]> = {
  atk_open: [
    ...
    {
      okWin: { k0: '你带头顶进点，对面还没站稳就被逼退。', k1: '你带头顶进去，放倒一个。队友涌进来了。', k2: '你带头顶进点，连着放倒两个。' },
      okLoss: { k0: '你顶进点逼退了第一个人，可身后的人没跟上。', k1: '你顶进点放倒一个，可身后的人没跟上。' },
      failWin: '你顶上去就被架住，只能退回来，队友换了个方向把点打开。',
      failLoss: '刚探头就被架住。节奏断在门口。',
    },
  ],
  atk_exec: [
    {
    ...
    },
    {
      ...
      failWin: '你守的那条路没人来，回防从另一边绕了进去。点里顶住了。',
  ...
  def_contact: [
    ...
    },
    {
      ...
      failWin: '你退得太早，这条路被对面白白拿走。回防打得干净。',
      failLoss: '退早了，这条路白送给了对面。',
    },
  ],
  def_execute: [
    {
  ...
  mid_fake: [
    {
      ...
      failWin: '转点的时候队伍拉得太长，前后脱了节。另一个点真的空着。',
  ...
  mid_rotate: [
    {
      ...
      failWin: '你刚转走，对面就从你原来的点压了进来。队友回头补住。',
      failLoss: '刚转走，对面就从你原来的点压了进来。',
    },
    {
      okWin: '你多等了一秒，果然是假打，真正的人冲进了你守着的点。',
      okLoss: '你等到确切的信息才动，位置没错，可对面这一波打得更好。',
      failWin: '你多等的这一秒让那边少了一个人。队友硬是撑住。',
      failLoss: '多等的这一秒，那边少了一个人。',
    },
  ],
  mid_trade: [
    {
      ...
      failWin: '你往前压早了一步，被逼了回来。队友稳住了阵型。',
      failLoss: '压早了一步，被逼回来，阵型也散了。',
    },
    {
      okWin: '你收拢回来和队友站成一排，对面一个一个撞了上来。',
      okLoss: '你们收拢站好了位置，可对面把技能一口气砸了下来。',
      failWin: '收拢的时候慢了半拍，位置被对面抢走。枪还是我们准。',
  ...
  mid_down: [
    {
      ...
      failWin: '三个人挤在一起反而被技能砸中。最后的枪没掉链子。',
    ...
    },
    {
      ...
      failWin: '你绕的那条路被对面看住，只能退回来。队友正面打得漂亮。',
  ...
  post_retake: [
    ...
    },
    {
      ...
      failWin: '你摸进去被对面先看到，只能退出来。队友的回防打得果断。',
  ...
  post_three: [
    {
      ...
      failWin: '三个人挤在一起被技能逼散。散开之后枪还是更快。',
    ...
    },
    {
      ...
      failWin: '两路没对上时间，你那一路先被发现。另一路补上了。',
  ...
  clutch_two: [
    ...
    },
    {
      ...
      failWin: '你绕后的路线被看穿，只能退回来。队友正面打赢了对枪。',
  ...
  eco_ours: [
    ...
    },
    {
      ...
      failWin: '你藏的位置被对面先摸到，只能换地方。队友那边打出了人数。',
      failLoss: '藏的位置被先摸到了。',
    },
  ],
  force_ours: [
    {
      ...
      failWin: '你没贴上去就被远处的枪线逼退。队友的步枪架住了。',
      failLoss: '没贴上去，就被远处的枪线逼退了。',
    },
    {
      ...
      failWin: '便宜的步枪没压住枪线，你被逼了回来。队友贴近打出了人数。',
  ...
  mp_mine_atk: [
    {
      ...
      failWin: '按体系进的时候节奏被对面卡了一下。临场有人补了一步。',
  ...
  mp_mine_def: [
    {
      ...
      failWin: '你们等得太久，被对面抢到了先手。回防打得坚决。',
    ...
    },
    {
      ...
      failWin: '你前压被逼了回来，点里少了一个人。队友硬是守住。',
      failLoss: '前压被逼了回来。点里少了一个人。',
    },
  ],
  mp_theirs_atk: [
    {
  ...
  ot_atk: [
    ...
    },
    {
      ...
      failWin: '加时开局冲得太猛，被架住了一下。队友把点打开。',
  ...
  ot_def: [
    {
      ...
      failWin: '站位守得太死，被对面的技能逼出了位置。回防打得干净。',
  ...
  weak_react: [
    {
      ...
      failWin: '你第一个进去就被架住，只能退出来。队友换了个方向把点打开。',
      failLoss: '第一个进去就被架住。这波进点停在门口。',
    },
    {
      okWin: '先锋先一步进去把里面翻了个遍，你跟在第二个，位置站得干干净净。',
      okLoss: '先锋先进，你跟第二个，进点的顺序没出错，可对面回防来得太快。',
      failWin: '你跟得太靠后，进去的时候点里已经打起来了。队友撑住了。',
  ...
  weak_read: [
    {
      ...
      failWin: '你留在这一侧守了个空，真打的是另一个点。回防赶得及。',
      failLoss: '守了个空。真打的是另一个点。',
    },
    {
      okWin: '你按指挥说的转了过去，那边的人数正好补齐。',
      okLoss: '你按指挥说的转了过去，人数也补齐了，可那边的技能太多。',
      failWin: '你一转走，你原来的那一侧就空了。队友回头补得快。',
  ...
  weak_call: [
    {
      ...
      failWin: '你报得有点乱，队友听了个半懂。他们自己把位置站对了。',
      failLoss: '报得有点乱。队友往三个方向散开。',
    },
    {
      okWin: '你没多说，退回去和队友会合，五个人站到一起，对面找不到落单的。',
      okLoss: '你退回去和队友会合，位置都站对了，可谁也不知道对面整队在哪。',
      failWin: '你退得太急，路上被对面追着走。队友把这一波扛了下来。',
      failLoss: '退得太急。看到的东西，一句也没报出去。',
    },
  ],
}
