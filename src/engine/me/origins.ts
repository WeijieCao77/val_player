 ...
 * 1 point, an attribute point is a point. Money is in RMB (me/currency.ts):
 * each card's old dollar amount at about seven to the dollar, rounded.
 */
...
export const ORIGINS: Origin[] = [
  ...
  { key: 'campus', name: '高校战队', blurb: '校队打了两年联赛，指挥过。', attrs: { communication: 3, igl: 5, aim: -2 }, tac: 10, money: 15000 },
  { key: 'town', name: '小镇做题家', blurb: '家里不宽裕，寄钱回家是每周的事；但坐得住。', mental: 6, trainMul: 1.12, upkeep: 800, money: 3000 },
  // the key is what saves hold: until 2026-09-11 this card was 「韩服天梯」, a League of Legends story rather than a VALORANT one
  { key: 'korea', name: '留学生', blurb: '在国外读书时一直在当地服务器打排位，英语语音交流没问题。', attrs: { awareness: 3, reaction: 2 }, ladder: 12, flags: { lang: 1 }, money: 18000 },
  { key: 'late', name: '大龄新人', blurb: '20 岁才决定试一次，上限低一点，但心态稳。', mental: 10, body: 4, attrs: { clutch: 3 }, flags: { late: 1 }, money: 35000 },
  { key: 'exchild', name: '退役选手之子', blurb: '父亲打过职业，圈里人都认识，也都盯着看。', scoutSeen: 5, fans: 30, mental: -3, attrs: { igl: 2 }, money: 60000 },
  { key: 'grinder', name: '死练型', blurb: '天赋一般，但每天十二小时。', attrs: { aim: -2, awareness: -2 }, trainMul: 1.2, body: 8, money: 10000 },
]
...
const RETIRED_ORIGINS: Origin[] = [
  { key: 'vodkid', name: '看录像长大的', blurb: '冠军赛决赛的录像看了几百遍，每一轮技能怎么交都背得出来。', attrs: { awareness: 3, utility: 2 }, mental: 3, money: 10000 },
