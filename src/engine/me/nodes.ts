...
export const NODE_HL: Record<string, HlOpt[]> = {
  ...
  clutch: [
    {
      okWin: { k0: '你往前压了一步，把两个人的位置逼得一清二楚，他们谁都没敢去碰芯片。', k1: '你先找到一个放倒，剩下那个被你的枪线逼得不敢去拆。', k2: '你先找到一个放倒，转身又把第二个等了出来，两个都是你收的。' },
      failLoss: { k0: '你想先找一个，刚探头就被两边同时夹住。', k1: '你先放倒了一个，第二个从另一侧绕了过来。' },
    },
    {
      okWin: { k0: '你藏在他们想不到的角落，一直没暴露，他们在拆除和找人之间犹豫到了最后。', k1: '你藏住了，等他们蹲下拆除的那一下才出枪，放倒一个，剩下那个没敢再碰芯片。', k2: '你藏住了，等他们来拆除的那一下出枪，两个都倒在芯片旁边。' },
  ...
  behind_site: [
    {
      ...
      failWin: '你换了位置，他们这回合偏偏没来，你守了个空——好在另一边顶住了。',
    ...
    },
    {
      ...
      failWin: '你还守在老位置，他们第四次压过来，人比上次多，你没顶住——好在回防的队友把点抢了回来。',
  ...
  ahead_rush: [
    {
      ...
      failWin: '冲得太急，阵型在拐角散了，好在队友补了上来。',
      failLoss: '冲得太急，被架住反打了一波。',
    },
    {
      okWin: '按道具一步一步推，没给对面任何机会。',
  ...
  map_point_mine: [
    ...
    },
    {
      ...
      failWin: '按体系打，对面早把这套看透了——还好有人临场改了一步。',
  ...
  ot: [
    ...
    },
    {
      ...
      failWin: '加时的激进开局冲得太猛，你被逼退了回来，好在队友把这回合扛了下来。',
  ...
  hot: [
    {
      ...
      failWin: '要了资源，手感却在这一回合凉了一下，好在队友接住了。',
  ...
  cold: [
    ...
    },
    {
      ...
      failWin: '硬扛的这一回合，简单的枪又漏了，好在队友兜住了。',
  ...
  intl: [
    {
      ...
      failWin: '想享受，声浪却把你的节奏冲乱了，好在队友稳住。',
  ...
  save: [
    {
      okWin: { k0: '队友喊保枪你没听，冲上去逼出了对面的位置，队友跟上来把回合翻了。', k1: '队友喊保枪你没听，冲上去放倒一个，这回合被你赌了回来。', k2: '队友喊保枪你没听，冲上去连着放倒两个，这回合被你赌了回来。' },
      okLoss: { k0: '你冲上去拖住了对面，差一口气就翻过来。', k1: '你冲上去放倒了一个，差一口气就翻过来。' },
      failWin: '你赌上去没赌中，好在队友那边把局面翻了过来。',
      failLoss: '你赌上去没赌中。',
    },
    {
  ...
  info: [
    {
      ...
      failWin: '跟上去被夹了一下，好在队友反应快。',
      failLoss: '跟上去被夹了一下。',
    },
    {
      okWin: '你退了一步报点，队友顺着你的信息打。',
      okLoss: '你退了一步报出点位，信息是准的。',
      failWin: '你退了，报了点，没人去接。',
      failLoss: '你退了，报了点，没人去接，信息浪费了。',
    },
  ],
  ...KEY_HL,
}
