...
const FIRST_NODES: NodeDef[] = [
  ...
  { id: 'clutch', phase: 'clutch', q: '1v2，爆能器已经安装好了，对面两个人在点位两侧。', ctx: '他们拆除之前，你必须先解决一个。',
...
/**
 * What the coach makes of a call: landing earns CALL_TRUST_OK of his regard,
 * missing costs CALL_TRUST_MISS — 破晓's +0.3 / −0.6, applied in
 * me/matchplay.ts choose.
 *
 ...
 *
 * No line says whether the round was taken, either (2026-09-18, a copy audit:
 * 497 of these lines ended 「……，这回合拿下 / 丢了。」 while the round record
 * and the ledger beside them already said so). The four cases are still four
 * lines — what happened is different when it landed and we lost — but the
 * result is the 拿下 / 丢了 beside the line on every screen that shows one
 * (scripts/check_language.ts 十), and the line tells what the round looked like.
 */
...
export const NODE_HL: Record<string, HlOpt[]> = {
  pistol_rush: [
    {
      okWin: { k0: '手枪局五个人一起压进去，你跟在后面补位，冲锋一口气打穿。', k1: '手枪局五个人一起压进去，你在拐角放倒一个，冲锋一口气打穿。', k2: '手枪局五个人一起压进去，你在拐角连着放倒两个。' },
      okLoss: { k0: '冲锋的时机是对的，可对面补位的枪更快。', k1: '冲锋的时机是对的，你也放倒了一个，可对面补位的枪更快。' },
      failWin: '五个人挤在一条道上被架住，冲锋停在了拐角。绕过去的队友接上了。',
      failLoss: '五个人挤在一条道上被架住，冲锋停在了第一个拐角。',
    },
    {
      okWin: '你们散开摸清了对面的站位，再一处一处压过去。',
      okLoss: '信息拿到了，对面站在哪一清二楚，可几次对枪都慢了半拍。',
      failWin: '散得太开，信息没传回来。正面的对枪赢了。',
      failLoss: '散得太开，信息没拿到，几路人互相接不上。',
    },
  ],
  entry: [
    {
      okWin: { k0: '你先探出去逼出了对面的枪位，身后四个人顺着压进点。', k1: '你先手放倒一个，身后四个人跟着压进点。', k2: '你先手连着放倒两个，身后四个人几乎是走进点的。' },
      okLoss: { k0: '你先探出去逼退了架枪的人，可补枪没跟上。', k1: '你先手放倒一个撕开了口子，可补枪没跟上。' },
      failWin: '先手没打出来，你被逼回了小道口，队友用技能把点重新撕开。',
      failLoss: '先手没打出来，你被逼回了小道口，进点的节奏断了。',
    },
    {
      okWin: '你压住了自己，等烟和闪光都落稳才进，五个人一起压上去。',
      okLoss: '烟和闪光都到位了，五个人一起进，可对面反应更快。',
      failWin: '等道具的这几秒，对面已经架好了枪，进点变成了硬啃——还是啃了下来。',
      failLoss: '等道具的这几秒，对面已经架好了枪，进点变成了硬啃。',
    },
  ],
  eco_gun: [
    {
      okWin: { k0: '你拿着全队唯一一把长枪卡住了关键的枪线，对面不敢往前走。', k1: '全队唯一一把长枪在你手里，你用它放倒一个打开了局面。', k2: '全队唯一一把长枪在你手里，你连着放倒两个。' },
      okLoss: { k0: '长枪在你手里架住了一条路，可别的路被打穿了。', k1: '长枪在你手里放倒了一个，可一把枪撑不起五个人。' },
      failWin: '全队指望的那把长枪没能打开局面，倒是队友拿着手枪抢到了位置。',
      failLoss: '全队指望的那把长枪没能打开局面。',
    },
    {
      okWin: '五把手枪套着轻甲一起冲，靠人数把点撕开。',
      okLoss: '五个人轻甲一起冲，时机是对的，可枪械的差距摆在那里。',
      failWin: '五个人轻甲冲上去，阵型被打散了，剩下的时间里队友硬是磨了下来。',
      failLoss: '五个人轻甲冲上去，被长枪的枪线顶了回来。',
    },
  ],
  clutch: [
    {
      okWin: { k0: '你往前压了一步，把两个人的位置逼得一清二楚，他们谁都没敢去碰爆能器。', k1: '你先找到一个放倒，剩下那个被你的枪线逼得不敢去拆。', k2: '你先找到一个放倒，转身又把第二个等了出来，两个都是你收的。' },
      failLoss: { k0: '你想先找一个，刚探头就被两边同时夹住。', k1: '你先放倒了一个，第二个从另一侧绕了过来。' },
    },
    {
      okWin: { k0: '你藏在他们想不到的角落，一直没暴露，他们在拆除和找人之间犹豫到了最后。', k1: '你藏住了，等他们蹲下拆除的那一下才出枪，放倒一个，剩下那个没敢再碰爆能器。', k2: '你藏住了，等他们来拆除的那一下出枪，两个都倒在爆能器旁边。' },
      failLoss: '藏得太久，等你探出头，局面已经被他们收拾干净了。',
    },
  ],
  behind_to: [
    {
      okWin: '暂停回来，你在语音里把节奏喊了回来，五个人重新站到一起。',
      okLoss: '暂停回来，你在语音里把大家喊醒了，打得也有章法。',
      failWin: '你喊了一嗓子，语音里没人接话。手上倒没乱。',
      failLoss: '你喊了一嗓子，语音里没人接话。',
    },
    {
      okWin: { k0: '你没说话，每一个位置都站得很稳，队友看着你的节奏跟了上来。', k1: '你没说话，一枪放倒一个，用枪把队友重新打醒了。' },
      okLoss: { k0: '你没说话，自己那条线守得很稳，可别的线被打穿了。', k1: '你没说话，放倒了一个，自己的枪是热的。' },
      failWin: '你闷头打自己的，语音里还是一片安静。手上倒没停。',
      failLoss: '你闷头打自己的，语音里还是一片安静。',
    },
  ],
  behind_site: [
    {
      okWin: '你换了位置，他们第四次压过来的时候扑了个空。',
      okLoss: '你换了位置，他们果然又压过来扑了个空，可转点太快没接上。',
      failWin: '你换了位置，他们这回合偏偏没来，你守了个空。另一边顶住了。',
      failLoss: '你换了位置，结果他们这回合压的正是你新站的那边。',
    },
    {
      okWin: { k0: '你硬守在原位，用技能和枪线把第四次进攻拖住，等来了回防的队友。', k1: '你硬守在原位，正面放倒一个，把第四次进攻顶了回去。', k2: '你硬守在原位，正面连着放倒两个，第四次进攻被你一个人顶了回去。' },
      okLoss: { k0: '你硬守在原位拖了很久，可他们人多。', k1: '你正面放倒了一个，可他们人多。' },
      failWin: '你还守在老位置，他们第四次压过来，人比上次多，你没顶住。回防的队友把点抢了回来。',
      failLoss: '你还守在老位置，他们第四次压过来，人比上次多。',
    },
  ],
  ahead_rush: [
    {
      okWin: '一波压上去，对面还没站好位置，速战速决。',
      okLoss: '一波压上去，时机没错，可对面的反应更快。',
      failWin: '冲得太急，阵型在拐角散了。队友补了上来。',
      failLoss: '冲得太急，被架住反打了一波。',
    },
    {
      okWin: '按道具一步一步推。对面没摸到机会。',
      okLoss: '按道具一步一步推，每一步都没出错，可对面这回合的枪就是更准。',
      failWin: '打得太慢，时间快到了才进点，进得很别扭——还是进下来了。',
      failLoss: '打得太慢，时间快到了才进点，进得很别扭。',
    },
  ],
  map_point_mine: [
    {
      okWin: { k0: '最后一波先手交给你，你第一个探出去把枪位逼了出来，队友顺着把点打开。', k1: '最后一波先手交给你，你放倒一个打开了口子。', k2: '最后一波先手交给你，你连着放倒两个。' },
      okLoss: { k0: '最后一波先手交给你，你第一个探出去逼出了枪位，可队友没跟上来。', k1: '最后一波先手交给你，你放倒一个打开了口子，可补枪慢了一步。' },
      failWin: '最后一波先手交给你，你没能打开局面，是队友从另一边绕进去。',
      failLoss: { k0: '最后一波先手交给你，可你没能打开局面。', k1: '最后一波先手交给你，你放倒了一个，可口子没撕开。' },
    },
    {
      okWin: '按体系打完最后一回合，谁都没有多做动作。',
      okLoss: '按体系打，每个人的位置都没错，可对面这回合的枪就是更准。',
      failWin: '按体系打，对面早把这套看透了。有人临场改了一步。',
      failLoss: '按体系打，可对面早把这套看透了。',
    },
  ],
  map_point_theirs: [
    {
      okWin: { k0: '对面赛点，你站出来要了这一波，队友跟着你的节奏打。', k1: '对面赛点，你站出来放倒一个。', k2: '对面赛点，你站出来连着放倒两个。' },
      okLoss: { k0: '对面赛点，你站出来要了这一波，节奏也打出来了。', k1: '对面赛点，你站出来放倒一个，剩下的人没接上。' },
      failWin: '对面赛点，你要来的这一波没打出来。队友替你顶上了。',
      failLoss: { k0: '对面赛点，你站出来要了这一波，没打出来。', k1: '对面赛点，你放倒了一个，可这一波没打出来。' },
    },
    {
      okWin: '对面赛点，五个人按流程打了一回合，稳住了。',
      okLoss: '对面赛点，五个人按流程打得一步不乱，可对面的枪更快。',
      failWin: '对面赛点，按流程走，每一步都被对面算到了。最后一个人硬是撑住了。',
      failLoss: '对面赛点，五个人按流程走，每一步都被对面算到了。',
    },
  ],
  ot: [
    {
      okWin: '加时，你深呼吸，按流程走，手稳了下来。',
      okLoss: '加时，你深呼吸，把手稳了下来，打得没毛病。',
      failWin: '加时，深呼吸也没压住手抖。队友手稳。',
      failLoss: '加时，深呼吸也没压住手抖。',
    },
    {
      okWin: { k0: '加时，你用一波激进的前压把自己逼进了状态，对面被压得不敢出头。', k1: '加时，你一波激进的前压放倒一个，手不抖了。' },
      okLoss: { k0: '加时，你前压逼自己进了状态，手不抖了。', k1: '加时，你前压放倒一个，手不抖了。' },
      failWin: '加时的激进开局冲得太猛，你被逼退了回来。队友把这回合扛了下来。',
      failLoss: '加时的激进开局冲得太猛，节奏乱了。',
    },
  ],
  first_map: [
    {
      okWin: '开局按流程走，心跳慢了下来。',
      okLoss: '开局按流程走，心态是稳的，人也没乱。',
      failWin: '按流程打，手还是有点僵，队友把节奏接了过去。',
      failLoss: '按流程打，手还是有点僵。',
    },
    {
      okWin: { k0: '开局就去找人，你先摸清了对面的位置，队友顺着你的报点打。', k1: '开局就去找人，你先找到对面，放倒一个。' },
      okLoss: { k0: '开局就去找人，你先摸清了对面的位置，可信息没换成回合。', k1: '开局就去找人，你先放倒一个。' },
      failWin: '开局就去找人，却被对面先发现，你退了回来。',
      failLoss: '开局就去找人，却被对面先发现。',
    },
  ],
  hot: [
    {
      okWin: { k0: '资源都给了你，你占着最好的枪线，对面没人敢从你那边过。', k1: '资源都给了你，你没浪费，放倒一个。', k2: '资源都给了你，你一个人就放倒两个。' },
      okLoss: { k0: '资源都给了你，你那条线守得纹丝不动，可别的线漏了。', k1: '资源都给了你，你放倒了一个，可其他人没接住。' },
      failWin: '要了资源，手感却在这一回合凉了一下。队友接住了。',
      failLoss: '要了资源，手感却在这一回合凉了。',
    },
    {
      okWin: '手感烫也没飘，按体系一步一步打。',
      okLoss: '手感烫也没飘，按体系打，打法没毛病。对面这回合更准。',
      failWin: '手感这么烫却按体系打，好几次机会从眼前过去。',
      failLoss: '手感这么烫却按体系打，机会从眼前过去。',
    },
  ],
  cold: [
    {
      okWin: '认了状态差，把好位置让给队友，你在后面报点补位，这回合反而顺了。',
      okLoss: '你把好位置让了出去，自己报点补位，配合是顺的。',
      failWin: '把位置让出去了，队友也没打顺——最后磕磕绊绊。',
      failLoss: '把位置让出去了，队友这回合也没打好。',
    },
    {
      okWin: { k0: '你硬扛着站在前面，枪还没开张，位置一步没退。', k1: '硬扛的这一回合，你放倒一个，手感找回来了。' },
      okLoss: { k0: '硬扛的这一回合心态稳住了，枪还没开张。', k1: '硬扛的这一回合，你放倒一个，手感找回来一点。' },
      failWin: '硬扛的这一回合，简单的枪又漏了。队友兜住了。',
      failLoss: '硬扛的这一回合，简单的枪又漏了。',
    },
  ],
  intl: [
    {
      okWin: '声浪里你还是听得见自己的报点。全场都在喊。',
      okLoss: '你把声浪当成了背景，节奏一点没乱。',
      failWin: '想享受，声浪却把你的节奏冲乱了。队友稳住了。',
      failLoss: '想享受，声浪却把你的节奏冲乱了。',
    },
    {
      okWin: { k0: '戴上降噪，世界只剩脚步和枪声，你的站位干净利落。', k1: '戴上降噪，世界只剩枪声，你放倒一个。' },
      okLoss: { k0: '戴上降噪，你打得很专注。', k1: '戴上降噪，你打得很干净，放倒一个。' },
      failWin: '降噪戴上了，队友的报点也听不太清。靠手感硬打的。',
      failLoss: '降噪戴上了，队友的报点也听不太清。',
    },
  ],
  save: [
    {
      okWin: { k0: '队友喊保枪你没听，冲上去逼出了对面的位置，队友跟上来把回合翻了。', k1: '队友喊保枪你没听，冲上去放倒一个。赌对了。', k2: '队友喊保枪你没听，冲上去连着放倒两个。这一把赌得值。' },
      okLoss: { k0: '你冲上去拖住了对面，差一口气就翻过来。', k1: '你冲上去放倒了一个，差一口气就翻过来。' },
      failWin: '你赌上去没赌中。队友那边把局面翻了过来。',
      failLoss: '你赌上去没赌中。',
    },
    {
      okWin: '你退下来准备保枪，结果队友那边把回合打了回来，枪也留住了。',
      okLoss: '你听队友的退了下来，枪保住了。',
      failWin: '保枪的路线被对面摸到，你被追着走，最后是队友把回合打了回来。',
      failLoss: '保枪的路线被对面摸到。',
    },
  ],
  info: [
    {
      okWin: { k0: '你跟上去二打二，枪线把对面逼得往回缩。', k1: '你跟上去二打二，放倒一个。', k2: '你跟上去二打二，两个都是你放倒的。' },
      okLoss: { k0: '你跟上去把人逼退了，可别的地方被打穿。', k1: '你跟上去放倒一个，这一波是赚的。' },
      failWin: '跟上去被夹了一下。队友反应快。',
      failLoss: '跟上去被夹了一下。',
    },
    {
      okWin: '你退了一步报点，队友顺着你的信息打。',
      okLoss: '你退了一步报出点位，信息是准的。',
      failWin: '你退了，报了点。没人接。',
      failLoss: '你退了，报了点。没人接，信息白报了。',
    },
  ],
  ...KEY_HL,
}
...
export function nodeLine(id: string, option: number, ok: boolean, f: RoundFacts): NodeLine {
  ...
  if (t == null) {
    // the round's result is the tag beside the line, as for every written one
    const text = ok ? '这一下做成了。' : '这一下没成。'
