...
console.log('三、协同、沟通')
{
  ...
  // a pair of a fresh 2+2 player (ease −12) and a Challengers regular (−2), against an 8+8 one (+6)
  const lowPair = -14, highPair = 4
  ...
  ok(d.form >= 2 && d.form <= 4.5, `状态差 ${f2(d.form)}，应在 2–4.5`)
