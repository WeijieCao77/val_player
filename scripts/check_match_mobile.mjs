...
const compiled = await build({
  stdin: { contents: `
    ...
    createRoot(document.getElementById('root')).render(<div className="app career"><GameCtx.Provider value={value}><MatchModal fixture={fixture} onClose={()=>{document.body.dataset.closed='yes'}}/></GameCtx.Provider></div>);
